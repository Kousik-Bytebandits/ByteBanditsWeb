...
const BlogSection = () => {
  ...
  return (
    <section className="blog-section bg-[#ececea] py-20 px-[20px] sm:px-[30px] md:px-[40px] lg:px-[20px]">
      {/* Section Heading */}
      ...
      <div className="flex flex-row gap-8 overflow-x-auto mx-50 scrollbar-hide"data-aos="fade-up"
        ...
        {blogData.map((blog, index) => (
          <div
            key={index}
            className="relative w-[300px] sm:w-[340px] md:w-[370px] lg:w-[600px] flex-shrink-0 bg-[#ececea] container "
          >
            {/* Tag */}
            ...
            <div className="mt-5 flex flex-row justify-between py-6 px-2 items-end">
              <p className="text-[12px] sm:text-[11px] md:text-[12px] lg:text-[25px] font-[anton] text-[#454545] leading-9 tracking-[0.5px] mb-10 max-w-[70%] text-blog-title">
                {blog.title}
              </p>
